...
class UploadComponent extends Component
{
     ...
     *
     * @param int $max_file_size Maximum size of uploaded file
     * @param string $accept_file_types The regular expression pattern
     ...
     */
    public function upload($max_file_size = null, $accept_file_types = null)
    {
