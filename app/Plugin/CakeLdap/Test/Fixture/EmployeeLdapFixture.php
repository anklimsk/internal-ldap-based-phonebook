<?php
/**
 * EmployeeLdap Fixture
 */
App::uses('CakeTestFixture', 'TestSuite/Fixture');

class EmployeeLdapFixture extends CakeTestFixture
{
    ...
    public $fields = [
        ...
        CAKE_LDAP_LDAP_ATTRIBUTE_OBJECT_GUID => ['type' => 'binary', 'null' => false, 'default' => null, 'length' => 16],
        ...
        CAKE_LDAP_LDAP_ATTRIBUTE_DEPARTMENT => ['type' => 'string', 'null' => true, 'default' => null, 'length' => 64, 'collate' => 'utf8_general_ci', 'charset' => 'utf8'],
        ...
        CAKE_LDAP_LDAP_ATTRIBUTE_MANAGER => ['type' => 'string', 'null' => false, 'default' => null, 'length' => 256, 'collate' => 'utf8_general_ci', 'charset' => 'utf8'],
        ...
        CAKE_LDAP_LDAP_ATTRIBUTE_OTHER_TELEPHONE_NUMBER => ['type' => 'text', 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'charset' => 'utf8'],
        CAKE_LDAP_LDAP_ATTRIBUTE_OTHER_MOBILE_TELEPHONE_NUMBER => ['type' => 'text', 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'charset' => 'utf8'],
        'indexes' => [
    ...
    public $records = [
        [
            ...
            CAKE_LDAP_LDAP_ATTRIBUTE_DEPARTMENT => 'УИЗ',
            ...
            CAKE_LDAP_LDAP_ATTRIBUTE_OTHER_TELEPHONE_NUMBER => ['+375171000001'],
        ...
        [
            'id' => '5',
            CAKE_LDAP_LDAP_DISTINGUISHED_NAME => 'CN=Матвеев Р.М.,OU=Пользователи,DC=fabrikam,DC=com',
            ...
            CAKE_LDAP_LDAP_ATTRIBUTE_OTHER_TELEPHONE_NUMBER => ['+375171000006'],
            CAKE_LDAP_LDAP_ATTRIBUTE_OTHER_MOBILE_TELEPHONE_NUMBER => [],
        ],
        [
            'id' => '6',
            CAKE_LDAP_LDAP_DISTINGUISHED_NAME => 'CN=Козловская Е.М.,OU=20-02,OU=ОИТ,OU=Пользователи,DC=fabrikam,DC=com',
            ...
            CAKE_LDAP_LDAP_ATTRIBUTE_MANAGER => 'CN=Хвощинский В.В.,OU=ОИТ,OU=Пользователи,DC=fabrikam,DC=com',
            CAKE_LDAP_LDAP_ATTRIBUTE_PHOTO => '',
            ...
            CAKE_LDAP_LDAP_ATTRIBUTE_OTHER_TELEPHONE_NUMBER => ['+375171000007'],
            CAKE_LDAP_LDAP_ATTRIBUTE_OTHER_MOBILE_TELEPHONE_NUMBER => [],
        ],
        [
            'id' => '7',
        ...
        [
            'id' => '8',
            CAKE_LDAP_LDAP_DISTINGUISHED_NAME => 'CN=Голубев Е.В.,OU=АТО,OU=Пользователи,DC=fabrikam,DC=com',
            ...
            CAKE_LDAP_LDAP_ATTRIBUTE_DIVISION => '',
            CAKE_LDAP_LDAP_ATTRIBUTE_DEPARTMENT => 'АТО',
        ...
        [
            'id' => '9',
            CAKE_LDAP_LDAP_DISTINGUISHED_NAME => 'CN=Марчук А.М.,OU=Пользователи,DC=fabrikam,DC=com',
            ...
            CAKE_LDAP_LDAP_ATTRIBUTE_DIVISION => '',
            CAKE_LDAP_LDAP_ATTRIBUTE_DEPARTMENT => 'Охрана труда',
        ...
        [
            'id' => '10',
            CAKE_LDAP_LDAP_DISTINGUISHED_NAME => 'CN=Чижов Я.С.,OU=09-02,OU=ОРС,OU=Пользователи,DC=fabrikam,DC=com',
            ...
            CAKE_LDAP_LDAP_ATTRIBUTE_DEPARTMENT => 'ТЕСТ',
            ...
            CAKE_LDAP_LDAP_ATTRIBUTE_MANAGER => 'CN=Матвеев Р.М.,OU=Пользователи,DC=fabrikam,DC=com',
            CAKE_LDAP_LDAP_ATTRIBUTE_PHOTO => '',
            ...
            CAKE_LDAP_LDAP_ATTRIBUTE_OTHER_TELEPHONE_NUMBER => ['+375171000010'],
            CAKE_LDAP_LDAP_ATTRIBUTE_OTHER_MOBILE_TELEPHONE_NUMBER => [],
        ],
    ];
    ...
    public function init()
    {
        ...
        foreach ($this->records as $i => &$record) {
            ...
            $record[CAKE_LDAP_LDAP_ATTRIBUTE_OBJECT_GUID] = hex2bin(str_replace('\\', '', GuidStringToLdap($record[CAKE_LDAP_LDAP_ATTRIBUTE_OBJECT_GUID])));
            $record[CAKE_LDAP_LDAP_ATTRIBUTE_OTHER_TELEPHONE_NUMBER] = serialize($record[CAKE_LDAP_LDAP_ATTRIBUTE_OTHER_TELEPHONE_NUMBER]);
            $record[CAKE_LDAP_LDAP_ATTRIBUTE_OTHER_MOBILE_TELEPHONE_NUMBER] = serialize($record[CAKE_LDAP_LDAP_ATTRIBUTE_OTHER_MOBILE_TELEPHONE_NUMBER]);
        }
