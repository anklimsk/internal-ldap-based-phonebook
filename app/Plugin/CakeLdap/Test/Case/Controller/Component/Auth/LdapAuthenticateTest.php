...
class LdapAuthenticateTest extends AppCakeTestCase
{
    ...
    public function testConstructor()
    {
        ...
        $object = new LdapAuthenticate($this->Collection, [
    ...
    public function testAuthenticateNoUsername()
    {
        ...
        $this->assertFalse($this->_targetObject->authenticate($request, $this->response));
    }
    ...
    public function testAuthenticateSuccess()
    {
        ...
        $result = $this->_targetObject->authenticate($request, $this->response);
        $expected = [
            'user' => 'Моисеева Л.Б.',
    ...
    protected function _createAuthComponet($externalAuth = false)
    {
        ...
        $this->_targetObject = new LdapAuthenticate($this->Collection, [
                'fields' => [
                    'username' => 'user',
                    'password' => 'password'
                ],
