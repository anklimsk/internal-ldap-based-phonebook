...
class EmployeeInfoBaseHelperTest extends AppCakeTestCase
{
    ...
    public function testGetInfo()
    {
        ...
        $expected = [
            ...
            __d('cake_ldap_field_name', 'Manager') => '<a href="/employees/view/7" target="_blank" link-use-modal="1" data-modal-title="' . __d('view_extension', 'Detail information') . '" class="popup-link text-nowrap" data-toggle="popover" data-popover-placement="auto top">Хвощинский В.В.</a> - Начальник отдела',
            ...
            __d('cake_ldap_field_name', 'Subordinate') => "\r\n" . '<ul class="bonsai-treeview" id="employee-tree">' . "\r\n" .
                "\t" . '<li data-id="4" class="parent"><a href="/employees/view/4" link-use-modal="1" data-modal-title="' . __d('view_extension', 'Detail information') . '" class="popup-link text-nowrap" target="_blank" data-toggle="popover" data-popover-placement="auto top">Дементьева А.С.</a> - Инженер' . "\r\n" .
                    "\t" . '<ul>' . "\r\n" .
                        "\t\t" . '<li data-id="5"><a href="/employees/view/5" link-use-modal="1" data-modal-title="' . __d('view_extension', 'Detail information') . '" class="popup-link text-nowrap" target="_blank" data-toggle="popover" data-popover-placement="auto top">Матвеев Р.М.</a> - Водитель</li>' . "\r\n" .
                    "\t" . '</ul>' . "\r\n" .
                "\t" . '</li>' . "\r\n" .
                '</ul>' . "\r\n"
        ];
        ...
        $expected = [
            ...
            __d('cake_ldap_field_name', 'Manag.') => '<a href="/employees/view/7" target="_blank" link-use-modal="1" data-modal-title="' . __d('view_extension', 'Detail information') . '" class="popup-link text-nowrap" data-toggle="popover" data-popover-placement="auto top">Хвощинский В.В.</a> - Начальник отдела',
        ...
        $expected = [
            '<a href="/employees/view/8" target="_blank" link-use-modal="1" data-modal-title="' . __d('view_extension', 'Detail information') . '" class="popup-link text-nowrap" data-toggle="popover" data-popover-placement="auto top">Голубев Е.В.</a>',
            'Голубев Е.В.',
            'Голубев',
            'Егор',
            'Владимирович',
            ...
            '<a href="/employees/view/7" target="_blank" link-use-modal="1" data-modal-title="' . __d('view_extension', 'Detail information') . '" class="popup-link text-nowrap" data-toggle="popover" data-popover-placement="auto top">Хвощинский В.В.</a> - Начальник отдела',
            [
                '12/14/1950',
                [
                    'class' => 'text-center'
