...
class SearchFilterComponent extends Component
{
    ...
    public function startup(Controller $controller)
    {
        ...
        $search_targetFields = $this->_modelSearch->getTargetFields();
        $search_targetFieldsSelected = $this->getTargetList();
        $search_targetDeep = $this->_modelConfigSearchInfo->getTargetDeep();
        $search_querySearchMinLength = $this->_modelConfigSearchInfo->getQuerySearchMinLength();
        $controller->set(compact('search_targetFields', 'search_targetFieldsSelected', 'search_querySearchMinLength', 'search_targetDeep'));
    }
